...
func stat_stat(prefix string, num string) *xdominion.XTable {
  ...
  // pagina
  t.AddField(xdominion.XFieldVarChar{Name: "pagina", Size: 250, Constraints: xdominion.XConstraints{
  ...
  // Tiempo
  t.AddField(xdominion.XFieldFloat{Name: "tiempo", Constraints: xdominion.XConstraints{
                                                    xdominion.XConstraint{Type: xdominion.NN},
                                                 } })
  ...
  // client
  t.AddField(xdominion.XFieldInteger{Name: "chef",})
  
  // dispositivo
  t.AddField(xdominion.XFieldVarChar{Name: "dispositivo", Size: 15,})
